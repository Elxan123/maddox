	...
	<div class="slider index2">
		<div class="all-slide owl-item">					
			<div class="single-slide" style="background-image:url(<?php echo base_url("public/img") ?>/slide2.jpg);">
			...
			<div class="single-slide" style="background-image:url(<?php echo base_url("public/img") ?>/slide1.jpg);">
				<div class="slider-overlay"></div>
				<div class="slider-text">						
					<div class="slider-wraper">					
